              ...
              <TenantDataProvider>
                <SidebarProvider>
                  ...
                  <SidebarInset className="overflow-x-hidden">
                    ...
                    <main className="min-h-screen pb-8 overflow-x-hidden pt-[69px] [&_.landing-page]:!pt-0 [&_.landing-page]:!pb-0 [&_.landing-page]:!min-h-0 [&_.landing-page]:!h-[calc(100vh-105px)]">
                      {children}
                    </main>
                    <ConditionalFooter />
                  </SidebarInset>
