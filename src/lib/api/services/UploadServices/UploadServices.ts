...
export class UploadServices extends BaseService<UploadServices> {
    ...
    async getPresignedUrl(
        ...
        const responseData = response as { data?: { url?: string; fields?: Record<string, string> } } | { url?: string; fields?: Record<string, string> };

        // Check if response has nested data property
        const presignedData = 'data' in responseData && responseData.data
            ? responseData.data
